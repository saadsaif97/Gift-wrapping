  ...
  function Extension() {
    ...
    function removeUnmergedGiftWrap() {
      if (!merge) {
        ...
        if (!(mergedVariants == null ? void 0 : mergedVariants.includes(target.merchandise.id))) {
          removeGiftWrap(wrappingId);
        }
      }
    }
    ...
    function getGiftWrap(productId2) {
      ...
      query product {
        product(id: "${productId2}") {
          ...
          return (_b = (_a2 = data == null ? void 0 : data.product) == null ? void 0 : _a2.metafield) == null ? void 0 : _b.value;
        } catch (error) {
          console.error(error);
        }
      });
